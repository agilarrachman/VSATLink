...
<head>
    <title>VSATLink - Solusi Internet Satelit Cepat dan Handal</title>
                    ...
                    <div id="swiper" class="swiper">
                      ...
                      <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="swiper-inner" data-bgimage="url(images/slider/VSAT1.png)">
                                <div class="sw-caption">
                                    <div class="container">
                                        <div class="row gx-5 align-items-center">
                                            <div class="col-lg-8 mb-sm-30">
                                                <div class="subtitle blink mb-4">Penawaran Spesial</div>
                                                <h1 class="slider-title text-uppercase mb-1">VSATLink<br>Aurora</h1>
                                            </div>
                                            <div class="col-lg-6">
                                                <p class="slider-text">Paket unggulan untuk operasional besar dengan kebutuhan data intensif. Dilengkapi prioritas bandwidth dan dukungan teknis 24 jam. Cocok untuk kantor pusat, tambang, dan area proyek besar</p>
                                                ...
                                                <a class="btn-main mb10" href="pricing-table-one.html"><span>Pesan Sekarang</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- Slides -->
                        <div class="swiper-slide">
                            <div class="swiper-inner" data-bgimage="url(images/slider/VSAT2.png)">
                                <div class="sw-caption">
                                    <div class="container">
                                        <div class="row gx-5 align-items-center">
                                            <div class="col-lg-8 mb-sm-30">
                                                <div class="subtitle blink mb-4">Penawaran Spesial</div>
                                                <h1 class="slider-title text-uppercase mb-1">VSATLink<br>Nova</h1>
                                            </div>
                                            <div class="col-lg-6">
                                                <p class="slider-text">Memberikan kecepatan tinggi dengan stabilitas premium. Ideal untuk kegiatan komunikasi real-time, video conference, dan monitoring sistem jarak jauh</p>
                                                <div class="sw-price wow fadeInUp">
                                                    <div class="d-starting">
                                                        Biaya Perangkat
                                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 mb-sm-20 wow fadeInRight" data-wow-delay="0s">
                            <div>
                                ...
                                <p>Nikmati internet satelit berkecepatan tinggi dan koneksi stabil untuk mendukung bisnis Anda di mana pun</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-sm-20 wow fadeInRight" data-wow-delay=".2s">
                            <div>
                                ...
                                <p>Dari kota besar hingga daerah terpencil, menghadirkan koneksi internet tanpa batas wilayah, solusi tanpa jaringan fiber</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-sm-20 wow fadeInRight" data-wow-delay=".4s">
                            <div>
                                ...
                                <p>Kami menjamin keamanan data dan privasi pelanggan dengan sistem enkripsi dan pengawasan jaringan 24 jam</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-sm-20 wow fadeInRight" data-wow-delay=".6s">
                            <div>
                                ...
                                <p>Tim teknis kami siap membantu Anda dengan dukungan cepat, ramah, dan berpengalaman di bidang satelit</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="padding60 sm-padding40 sm-p-2 jarallax position-relative">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <p class="wow fadeInUp" style="color: white">VSATLink adalah penyedia layanan internet satelit yang berfokus menghadirkan koneksi cepat, stabil, dan menjangkau seluruh wilayah Indonesia, bahkan di daerah tanpa jaringan fiber</p>
                                        <div class="spacer-10"></div>
                                    </div>
                                </div>

                                <img src="images/misc/VSAT no bg.png" class="me-5 sm-hide position-absolute bottom-0 end-0 wow fadeIn"  alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row align-items-center gx-5">
                        <div class="col-lg-6" style="max-height: 380px">
                            <img src="images/misc/map indo.png" class="img-fluid mb-sm-30 wow fadeIn" alt="" style="object-fit:cover;">
                        </div>

                        <div class="col-lg-6">
                            <div class="subtitle wow fadeInUp mb-3">Area Cakupan</div>
                            <h2 class="wow fadeInUp" data-wow-delay=".2s"><span class="text-gradient">100+</span> lokasi layanan VSATLink di seluruh Indonesia</h2>
                            <p class="wow fadeInUp">VSATLink menjangkau berbagai wilayah dari perkotaan hingga pelosok nusantara. Kami memastikan koneksi internet tetap cepat dan stabil, bahkan di area tanpa jaringan kabel atau fiber</p>
                        ...
                        <div class="col-md-6 gallery-item" id="card">
                            <div class="de-item wow h-100">
                                <div class="d-overlay">
                                    ...
                                    <div class="d-text">
                                        <h4>VSATLink Aurora</h4>
                                        <div class="detail-info">
                                            <p class="d-info">Kapasitas Kuota Bulanan <span class="info">120 GB/bulan</span></p>
                                            <p class="d-info">Kecepatan Akses <span class="info">Up to 50 Mbps download / 5 Mbps upload</span></p>
                                            <p class="d-info">Cocok Untuk <span class="info">Pertambangan & Proyek industri berat</span></p>
                                        </div>
                ...
                <div class="container">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="accordion-section">
                            ...
                            <p>VSAT (Very Small Aperture Terminal) adalah layanan internet satelit yang memungkinkan koneksi data di area tanpa jaringan kabel atau fiber optik.</p>
                            </div>
                            ...
                            <p>VSATLink menjangkau seluruh wilayah Indonesia, termasuk daerah terpencil di mana jaringan fiber belum tersedia.</p>
                            </div> 
                            ...
                            <p>Koneksi cepat dan stabil, jangkauan luas, keamanan tinggi, serta dukungan teknis profesional 24 jam.</p>
                            </div>
                            ...
                            <p>Ya, layanan kami dirancang untuk mendukung kebutuhan komunikasi dan data bisnis, pemerintahan, maupun pribadi di area terpencil.</p>
                            </div>
                            ...
                            <p>Anda dapat mengisi formulir pemesanan di situs kami atau menghubungi tim sales untuk mendapatkan penawaran dan proses instalasi.</p>
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="accordion-section">
                            ...
                            <p>Waktu instalasi biasanya antara 3–7 hari kerja tergantung lokasi dan kondisi lapangan.</p>
                            </div>
                            ...
                            <p>Ya, layanan VSATLink beroperasi 24 jam dengan pemantauan jaringan dan dukungan teknis nonstop.</p>
                            </div>
                            ...
                            <p>Tentu, jaringan VSATLink mendukung penggunaan untuk CCTV, VPN, dan kebutuhan data lainnya sesuai konfigurasi.</p>
                            </div>
                            ...
                            <p>Tim teknis kami siap membantu melalui layanan dukungan 24 jam untuk memastikan koneksi Anda tetap aktif dan stabil.</p>
                            </div>
                            ...
                            <p>Ya, kami menyediakan paket korporasi dengan bandwidth khusus, prioritas dukungan, dan opsi konfigurasi sesuai kebutuhan bisnis Anda.</p>
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-lg-6">
                            <div class="row g-4">
                                ...
                                <div class="col-sm-2 col-4">
                                    <div class="p-2 rounded-10 d-flex" data-bgcolor="rgba(255, 255, 255, .05)" style="height: 100%">
