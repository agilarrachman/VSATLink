...
@section('content')
    <div class="no-bottom no-top" id="content">
        ...
        <section id="subheader" class="jarallax">
            ...
            <img
                src="images/covers/produkVSAT1.png"
                class="jarallax-img"
                alt=""
            />
        ...
        <section class="no-top">
            <div class="container">
                <div class="row g-4">
                    ...
                    <div
                        class="col-lg-3 col-sm-6 wow fadeInRight"
                        data-wow-delay="0s"
                    >
                        <div>
                            <img
        ...
        <section class="no-top" id="spesifikasiLayanan">
            <div class="container">
                <div class="row g-4">
                    ...
                    <div
                        class="col-lg-6 col-sm-12 wow fadeInRight"
                        data-wow-delay="0s"
                    >
                        <h2 class="wow fadeInUp mb20" data-wow-delay=".2s">
                            Perangkat
        ...
        <section class="no-top">
            <div class="container">
                <div class="row g-4">
                    ...
                    <div
                        class="sw-price col-lg-6 col-sm-12 wow fadeInRight"
                        data-wow-delay="0s"
                    >
