<table width="600" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td style="padding:30px; color:#333333;">
            ...
            <p style="font-size:15px; line-height:1.6;"> Kami informasikan bahwa pesanan berikut telah <strong>diterima
                    oleh customer</strong>. Mohon segera melakukan pengajuan jadwal
                <strong>instalasi dan aktivasi</strong>.
            </p>
            ...
            <p style="font-size:14px; line-height:1.6;"> Silakan segera mengajukan jadwal
                instalasi dan proses aktivasi layanan melalui VSATLink Admin. </p>
